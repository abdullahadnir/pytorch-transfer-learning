...
data_dir = 'C:/Users/Abdullah/Desktop/bitirmeProje/veriseti'
...
# ^^^^^^^^^^^^^^^^^^^^^^
# Let's visualize a few ing images so as to understand the data
# augmentations.
...
print('Accuracy of the network on the %d test images: %d %' %(dataset_sizes["TEST"], 100*correct/total))